...
final class StickyNotesPerformanceTests: XCTestCase {
    ...
    func testBulkNoteCreationPerformance() {
        ...
        measure {
            for i in 1...1000 {
                let _ = persistenceController.createNote(
                    title: "Bulk Note \(i)",
    ...
    func testNoteFetchPerformance_SmallDataset() {
        ...
        measure {
            let _ = try? persistenceController.fetchNotes()
        }
    }
    ...
    func testNoteSearchPerformance_SmallDataset() {
        ...
        measure {
            let _ = try? persistenceController.searchNotes(query: "searchable")
        }
    }
    ...
    func testCategoryFilteringPerformance() {
        ...
        measure {
            let _ = try? persistenceController.notesByCategory("Work")
        }
    }
    ...
    func testPinnedNotesFetchPerformance() {
        ...
        measure {
            let _ = try? persistenceController.pinnedNotes()
        }
    }
    ...
    func testComplexQueryPerformance() {
        ...
        measure {
            let _ = try? persistenceController.fetchNotes(predicate: compoundPredicate)
        }
    }
    ...
    func testPaginationPerformance() {
        ...
        measure {
            for page in 0..<20 { // 20 pages of 50 = 1000 notes
                ...
                let _ = try? testContext.fetch(fetchRequest)
            }
        }
    }
    ...
    func testValidationPerformance() {
        ...
        measure {
            for note in notes {
                let _ = try? note.validateTitle()
                let _ = try? note.validateContent()
            }
        }
    }
    ...
    func testComputedPropertiesPerformance() {
        ...
        measure {
            for note in notes {
                let _ = note.displayTitle
                let _ = note.previewContent
                let _ = note.formattedCreatedDate
                let _ = note.formattedUpdatedDate
            }
        }
    }
