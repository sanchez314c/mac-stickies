...
class CacheService {
    ...
    private func setupMemoryWarningObserver() {
        // macOS does not have UIApplication memory warnings.
        // Use NSWorkspace notifications or Mach memory pressure API for production.
        // For now, register a periodic trim on NSApplication termination.
