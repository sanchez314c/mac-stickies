...
struct NoteWindowView: View {
    ...
    var body: some View {
        ...
        // Window size is controlled by NSWindow — use maxWidth/maxHeight to fill it
        ...
        // Window dragging is handled by isMovableByWindowBackground on StickyNoteWindow.
        // A DragGesture here would interfere with text selection — removed.
    }
}
