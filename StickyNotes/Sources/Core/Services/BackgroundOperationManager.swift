...
public final class BackgroundOperationManager {
    ...
    /// Bulk update notes — updates are performed asynchronously via Task
    @discardableResult
    ...
    /// Search and replace across all notes — runs asynchronously via Task
    @discardableResult
    ...
    /// Duplicate multiple notes — runs asynchronously via Task
    @discardableResult
